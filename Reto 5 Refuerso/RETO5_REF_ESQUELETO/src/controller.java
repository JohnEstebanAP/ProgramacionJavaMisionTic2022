...
public class controller {
    ...
    void addMedicButtonClick(ActionEvent event) {
        if (mNameTextField.getText().isEmpty() || mIDTextField.getText().isEmpty() || mAgeTextField.getText().isEmpty()
            ...
            System.out.println("Tienen que yenar todos los campos del medico");
            Alert alert = new Alert(AlertType.ERROR);
            alert.setTitle("ERROR");
            alert.setHeaderText(null);
            alert.setContentText("¡Los campos de texto no pueden estar vacios!");
            alert.setResizable(true); // para que la alerta tenga un tamaño y se pueda ver y modificar su tamaño
            alert.showAndWait();
        } else {
            try {
    ...
    void searchMedicButtonClick(ActionEvent event) {
        if (searchMIDTextField.getText().isEmpty()) {
            ...
            String searchID = searchMIDTextField.getText(); // Aqui debe obtener el texto de la variable
                                                            // searchMIDTextField
    ...
    void deleteMedicButtonClick(ActionEvent event) {
        if (searchMIDTextField.getText().isEmpty()) {
            ...
            try {
                ...
                alert.setTitle("ERROR");
                alert.setHeaderText(null);
                alert.setContentText("¡El Id del medico a eliminar no se a encontrado!");
                alert.setResizable(true); // para que la alerta tenga un tamaño y se pueda ver y modificar su tamaño
                alert.showAndWait();
            }
        }
