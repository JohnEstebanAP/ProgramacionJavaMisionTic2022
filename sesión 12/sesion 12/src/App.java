...
public class App {
   ...
   public static void main(String[] args) throws Exception {
    ...
    public static void menu(){
        ...
        System.out.println("Opcion 0: Imprimir producto");
    ...
    public static void imprimir(){
        ...
        System.out.println("Opcion 0: Imprimir Todo referente al producto");
        System.out.println("Opcion 1: Imprimir código y descripción del producto");
        System.out.println("Opcion 2: Imprimir datos relevantes del producto");
        ...
        if(tipo.equals("P")){
            for(int i = 0; i < vectorPrendasVestir.length; i++){
                if(codigoProducto == vectorPrendasVestir[i].getCodigo()){
                    switch(resultado){
                        case 1:
                            System.out.println(vectorPrendasVestir[i].mostrarTodo());
                            break;
                        case 2: 
                            System.out.println(vectorPrendasVestir[i].mostrarParte1());
                            break;
                        case 3:
                            System.out.println(vectorPrendasVestir[i].mostrarParte2());
                            break;
                    }
                }
            }
            ...
            for(int i = 0; i < vectorCalzado.length; i++){
                if(codigoProducto == vectorCalzado[i].getCodigo()){
                    switch(resultado){
                        case 1:
                            System.out.println(vectorCalzado[i].mostrarTodo());
                            break;
                        case 2: 
                            System.out.println(vectorCalzado[i].mostrarParte1());
                            break;
                        case 3:
                            System.out.println(vectorCalzado[i].mostrarParte2());
                            break;
                    }
                }
            }
